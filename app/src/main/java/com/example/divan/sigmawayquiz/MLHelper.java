...
public class MLHelper  extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    // Database Name
    private static final String DATABASE_NAME = "MLQuiz";
    ...
    public MLHelper(Context context) {
    ...
    private void addQuestions() {
        Question q1 = new Question("Different learning methods does not include?","Memorization","Analogy","Introduction","Deduction","Introduction");
        this.addQuestion(q1);

        Question q2 = new Question("Semantic grammars",
        ...
        Question q3 = new Question("Machine learning is",
        ...
        Question q4 = new Question("Perception involves",
                "Dancing",
        ...
        Question q5 = new Question("A model of language consists of the categories which does not include",
                "System constraints",
